<?php
    ...
    return array(
        'themes' => array(
            ...
            'Styles <i>:name</i> deleted' => 'Styles <i>:name</i> deleted',
            'Script <i>:name</i> deleted' => 'Script <i>:name</i> deleted',
            'Template <i>:name</i> deleted' => 'Template <i>:name</i> deleted',
            'Templates' => 'Templates',
            'Clone' => 'Clone',
            'Edit' => 'Edit',
            'Delete' => 'Delete',
            ...
            'This chunk does not exist' => 'This chunk does not exist',
            'This template does not exist' => 'This template does not exist',
            'This styles does not exist' => 'This styles does not exist',
            'This script does not exist' => 'This script does not exist',
            ...
            'Your changes to the script <i>:name</i> have been saved.' => 'Your changes to the script <i>:name</i> have been saved.',
            ...
            'Delete script: :name' => 'Delete script: :name',
        )
    );
