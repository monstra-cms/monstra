<?php
    ...
    return array(
        'system' => array(
            ...
            'Loading...' => 'Loading...',
            'Authorize' => 'Authorize',
            'Please check your analytics settings then exit from google account and authorize with right google analytics account.' => 'Please check your analytics settings then exit from google account and authorize with right google analytics account.',
            'Client ID' => 'Client ID',
            'API key' => 'API key',
            'View ID' => 'View ID',
            'Tracking ID' => 'Tracking ID',
            'Request was denied because it contained an invalid security token. Please refresh the page and try again.' => 'Request was denied because it contained an invalid security token. Please refresh the page and try again.',
