<?php
    ...
    return array(
        'system' => array(
            ...
            'Help' => 'Pomoc',
            'Goggle Analytics' => 'Goggle Analytics',
            'Loading...' => 'Ładowanie...',
            'Authorize' => 'Autoryzuj',
            'Please check your analytics settings then exit from google account and authorize with right google analytics account.' => 'Proszę sprawdź swoje ustawienia Google Analytics, następnie wyloguj się z konta Google i autoryzuj z uprawnieniami konta Google Analytics.',
            'Client ID' => 'ID klienta',
            'API key' => 'Klucz API',
            'View ID' => 'ID widoku',
            'Tracking ID' => 'ID śledzenia',
            'Request was denied because it contained an invalid security token. Please refresh the page and try again.' => 'Żądanie zostało odrzucone, ponieważ zawierało nieprawidłowy token zabezpieczający. Proszę odświeżyć stronę i spróbować ponownie.',
